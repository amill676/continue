...
export class InletMappingWebviewProvider implements vscode.WebviewViewProvider {
  ...
  getPanelHtml(
    ...
    if (!inDevelopmentMode) {
      ...
      scriptUri = "http://localhost:5173/src/mapping.tsx";
    ...
    <body>
      ...
      ${
        ...
        window.__vite_plugin_reactgra_preamble_installed__ = true
        </script>`
          : ""
      }
