...
const TableWrapper = attach(
  ...
  MantineReactInnerTargetTable,
  {
    ...
    targetFieldSuggestions: 'targetFieldSuggestions',
    ...
    onGetFieldSuggestions: store.getFieldSuggestions.bind(store),
    onFocusSuggestionSearch: store.handleFocusSuggestionSearch.bind(store),
